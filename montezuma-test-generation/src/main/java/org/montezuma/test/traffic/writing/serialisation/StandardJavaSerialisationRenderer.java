...
public class StandardJavaSerialisationRenderer implements SerialisationRenderer {
	...
	public ExpressionRenderer internalGetDeserialisationCodeChunkFor(CodeChunk codeChunkNeedingDeserialisation, Object object) throws IOException {
		...
		codeChunkNeedingDeserialisation.requiredImports.add(new Import("java.io.ObjectInputStream"));
		codeChunkNeedingDeserialisation.requiredImports.add(new Import("java.io.ByteArrayInputStream"));
		codeChunkNeedingDeserialisation.requiredImports.add(new Import("java.io.IOException"));
		codeChunkNeedingDeserialisation.requiredImports.add(new Import("java.lang.ClassNotFoundException"));
		codeChunkNeedingDeserialisation.requiredImports.add(new Import(object.getClass().getName()));
