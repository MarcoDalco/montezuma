...
public class ClassVisibilityAndTypeOptimisationCaseNoExternalInvokedClassTestWriter {
	/**
	...
	public static void main(String[] args) throws FileNotFoundException, ClassNotFoundException, NoSuchMethodException, InstantiationException, IllegalAccessException, InvocationTargetException, IOException {
		...
		CasesCommon.generateTestsFor(ClassVisibilityAndTypeOptimisationCaseMainClass.class, dontMockClasses, ClassVisibilityAndTypeOptimisationCaseTrafficRecorder.CLASS_VISIBILITY_AND_TYPE_OPTIMISATION_CASE_RECORDING_SUBDIR, CasesCommon.parseArguments(args), classJavadoc);
	}
