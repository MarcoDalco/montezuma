...
public class ClassVisibilityCaseTestWriter {
	...
	public static void main(String[] args) throws FileNotFoundException, ClassNotFoundException, NoSuchMethodException, InstantiationException, IllegalAccessException, InvocationTargetException, IOException {
		final String classJavadoc= "This test has a complex explanation. Please look at its test-writer class, " + ClassVisibilityCaseTestWriter.class;
		CasesCommon.generateTestsFor(
				ClassVisibilityCaseMainClass.class, TrafficToUnitTestsWriter.getDontMockClasses(), ClassVisibilityCaseTrafficRecorder.CLASS_VISIBILITY_CASE_RECORDING_SUBDIR, CasesCommon.parseArguments(args), classJavadoc);
	}
