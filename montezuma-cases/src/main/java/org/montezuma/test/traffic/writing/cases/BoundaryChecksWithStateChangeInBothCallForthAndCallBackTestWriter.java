...
public class BoundaryChecksWithStateChangeInBothCallForthAndCallBackTestWriter {
	...
	public static void main(String[] args) throws FileNotFoundException, ClassNotFoundException, NoSuchMethodException, InstantiationException, IllegalAccessException, InvocationTargetException, IOException {
		new TrafficToUnitTestsWriter().generateTestsFor(
				B.class, TrafficToUnitTestsWriter.getDontMockClasses(), BoundaryChecksWithStateChangeinBothCallForthAndCallBackTrafficRecorder.BOUNDARY_CHECKS_RECORDING_SUBDIR, CasesCommon.TEST_CLASS_PATH);
	}
