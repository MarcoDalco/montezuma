...
public class CompiledStatementStoringPreparedStatementCreator1Test {
  ...
  @Mocked private MyPreparedStatement mockedMyPreparedStatement0;
  @Mocked private MyConnection mockedMyConnection1;
  ...
  mockedMyConnection1.prepareStatement(givenString2); times = 1; result = mockedMyPreparedStatement0;
  mockedMyPreparedStatement0.setObject(givenInteger5, givenLong6); times = 1;
}};

    assertEquals(mockedMyPreparedStatement0, cut.createPreparedStatement(mockedMyConnection1));
